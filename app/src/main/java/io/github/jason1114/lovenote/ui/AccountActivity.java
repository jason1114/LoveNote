...
public class AccountActivity extends AbstractAppActivity
    ...
    private static final String ACTION_OPEN_FROM_APP_INNER = "io.github.jason1114.lovenote:accountactivity";
    private static final String ACTION_OPEN_FROM_APP_INNER_REFRESH_TOKEN = "io.github.jason1114.lovenote:accountactivity_refresh_token";
    ...
    private class AccountListItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            Intent intent = MainNotesActivity.newIntent(accountList.get(i));
    ...
    private class AccountAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if (!TextUtils.isEmpty(accountList.get(i).getAvatarUrl())) {
                getBitmapDownloader()
        ...
        private BitmapDownloader getBitmapDownloader() {
